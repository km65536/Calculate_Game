// 【バージョン更新】リサイズ計算のバグを完全修正 ver 1.1.6
const GAME_VERSION = "ver 1.1.6";
...
async function loadMapCSV(url) {
    try {
        ...
        // 包む親コンテナの大きさもCanvasサイズに厳密にジャストフィットさせる
